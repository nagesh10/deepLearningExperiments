print "myKerasNN.py"
basePath = 'home/gor/projects/vikram/myKerasNN/'
...
[imRows, imCols, (trainImages, trainResults), valData, (testImages, testResults), fulltestImages] = loadData(nbClasses, date)
...
# Save the model
modelName = '/home/gor/projects/vikram/myKerasNN/myKerasSmallNNModelWithHingeLoss_' + timeStr + '.h5'
